...
Branch](https://github.com/bitcoinops/bitcoin/releases/tag/Taproot_V0.1.1).
...
V0.1 branch](https://github.com/bitcoinops/bitcoin/releases/tag/Taproot_V0.1.1) which
...
Checkout the Optech taproot branch, which is tagged as `Taproot_V0.1.1`:

```
$ git checkout Taproot_V0.1.1
```
